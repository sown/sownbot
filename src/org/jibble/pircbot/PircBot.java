...
public abstract class PircBot implements ReplyConstants {
     ...
     */
    @SuppressWarnings("unchecked") private final void addUser(String channel, User user) {
        channel = channel.toLowerCase();
        synchronized (_channels) {
            Hashtable users = (Hashtable) _channels.get(channel);
            if (users == null) {
    ...
    private final void removeAllChannels() {
        synchronized(_channels) {
            _channels = new Hashtable<String,Hashtable>();
        }
    }


    @SuppressWarnings("unchecked") private final void updateUser(String channel, int userMode, String nick) {
        channel = channel.toLowerCase();
        synchronized (_channels) {
            Hashtable users = (Hashtable) _channels.get(channel);
            User newUser = null;
    ...
    private Hashtable<String,Hashtable> _channels = new Hashtable<String,Hashtable>();
